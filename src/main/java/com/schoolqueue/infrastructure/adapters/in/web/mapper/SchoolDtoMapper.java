...
public final class SchoolDtoMapper {
  ...
  public static UpdateSchoolCommand toCommand(UUID id, UpdateSchoolRequest request) {
    return new UpdateSchoolCommand(id, request.name(), request.latitude(), request.longitude());
  }
